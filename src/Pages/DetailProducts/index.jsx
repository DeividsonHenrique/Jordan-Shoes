    ...
    <>
      <Main>
        ...
        <ProdutosDetalhes key={product.id}>
          <DetalhesImagens>
            <Fade direction="up" duration={300} cascade triggerOnce>
              <figure>
          ...
          <div>
            <Fade direction="down" duration={300} cascade triggerOnce>
              <Detalhes>
              ...
              <Descricao>
                ...
                <ul>
                  <li>
                    Cabedal em material genuíno, sintético e tecido para
                    sensação de suporte.
                  </li>
                  <li>
